...
class GestionEmprunts {
    constructor() {
        ...
        this.adherents = new Map([
            ["001", { id: "001", nom: "Dupont", prenom: "Jean", email: "jean.dupont@email.com", emprunts: [],retours: [] }],
            ["002", { id: "002", nom: "Martin", prenom: "Sophie", email: "sophie.martin@email.com", emprunts: [],retours: [] }],
            ["003", { id: "003", nom: "Lefevre", prenom: "Pierre", email: "pierre.lefevre@email.com", emprunts: [],retours: [] }],
            ["004", { id: "004", nom: "Dufour", prenom: "Marie", email: "marie.dufour@email.com", emprunts: [],retours: [] }],
            ["005", { id: "005", nom: "Leroy", prenom: "Lucas", email: "lucas.leroy@email.com", emprunts: [],retours: [] }],
            ["006", { id: "006", nom: "Bertrand", prenom: "Anna", email: "anna.bertrand@email.com", emprunts: [],retours: [] }],
        ]);
