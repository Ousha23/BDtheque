...
function afficherResultatsRecherche(adherent) {
     ...
     if (adherent && adherent.CodeAdherant && adherent.nom && adherent.email) {
        // Afficher les résultats de la recherche
        console.log("Résultats de la recherche pour l'adhérent : ", adherent);
        // ... (le reste de votre code d'affichage)
    } else {
        console.error("L'adhérent n'est pas défini ou ne possède pas toutes les propriétés nécessaires.");
    }
    ...
    <p style="font-size: 20px;"><span style="margin-right: 80px;"> <strong>ID Adhérent:</strong> ${adherent.CodeAdherant}</span>  <span><strong>Email:</strong> ${adherent.email}</span></p></br>
    ...
    document.getElementById("numeroAdherent").value = adherent.CodeAdherant;
